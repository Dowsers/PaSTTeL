...
#include "utiles.h"  // PreprocessingCancelledException
...
public:
    ...
    // cancel_flag: checked periodically during the (potentially exponential,
    // see distributeAND) DNF expansion; throws PreprocessingCancelledException
    // as soon as it's set. Optional (nullptr = never cancel).
...
private:
    ...
    // Distribuer AND sur plusieurs DNF -- see parseFormulaToDNF for cancel_flag
